...
const youtubeSearch = require('./applications/youtube/youtubeSearch').youtubeSearch;
const spotifySearch = require('./applications/spotify/spotifySearch').spotifySearch;
...
// Resolving the error while running 'node app.js' --> https://chat.openai.com/chat/2f3c2eab-60f3-42c7-8427-58feb189ca3c
...
/* Access Token and Refresh Token Related
 ...
 // For us, this step's aim is to have Spotify recognize the user and play the full song instead of the sample 30 seconds.
...
/* Since we are now declaring the variables locally. We need not empty every array.
